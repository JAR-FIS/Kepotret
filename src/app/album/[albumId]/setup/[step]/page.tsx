...
export default function SetupStepPage() {
  ...
  return <>
    ...
    <section className="max-w-3xl rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-surface)] p-5 sm:p-7" aria-live="polite"><h2 className="font-semibold">{t(currentStep)}</h2><p className="mt-2 text-sm leading-6 text-[var(--color-muted-foreground)]">{t('unavailable')}</p></section>
  </>;
}
